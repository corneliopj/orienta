<div class="row">
    <div class="col">
        <h2 class="page-header"><?php echo $id ? 'Editar Atendimento' : 'Registrar Novo Atendimento'; ?></h2>
        
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h3 class="card-title"><i class="bi bi-journal-plus"></i> <?php echo $id ? 'Editar Atendimento' : 'Registrar Atendimento'; ?></h3>
            </div>
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control date-mask" name="data_atendimento" placeholder="dd/mm/aaaa" value="<?php echo htmlspecialchars(formatDate($atendimento['data_atendimento'] ?? '')); ?>" required>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="descricao" rows="5" required><?php echo htmlspecialchars($atendimento['descricao'] ?? ''); ?></textarea>
                    </div>
